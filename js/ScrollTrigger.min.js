...
!function(e, t) {
    ...
    function Ja(e, t, r, n, o, i, a, s, l, c, f, u) {
        ...
        H(e))
            ...
            G(t) && (t = t(s));
            var p, d, g, h = Ce(t)[0] || Se, v = ea(h) || {}, m = e.split(" ");
            v && (v.left || v.top) || "none" !== ba(h).display || (g = h.style.display,
    ...
    function Ma(l, e) {
        var c, f = C(l) ? e.sc : D(l, e), u = "_scroll" + e.p2;
        return l[u] = f,
    ...
    var xe, o, we, Te, x, Se, i, a, s, l, Ce, ke, _e, c, Me, Pe, f, Ee = 1, Oe = Date.now, u = Oe(), ze = 0, Fe = 1, Ae = Math.abs, t = "scrollLeft", r = "scrollTop", p = "left", d = "top", y = "right", w = "bottom", Ie = "width", Le = "height", De = "Right", Be = "Left", Ge = "Top", Ne = "Bottom", Re = "padding", je = "margin", He = "Width", We = "Height", qe = "px", Je = {
        s: t,
        p: p,
        p2: Be,
        os: y,
        ...
        i[r.p] = t,
        xe.set(e, i)
    }, Ve = [], Ze = {}, h = {}, n = [], v = function _dispatch(e) {
        ...
        var e = Ve.length
          ...
          , r = Oe()
          , n = 50 <= r - u;
        for (n && (ze && !Pe && 200 < r - ze && (ze = 0,
        v("scrollEnd")),
        _e = u,
        u = r); t < e; t++)
            Ve[t] && Ve[t].update(0, n);
        l = 0
    }, b = [p, d, w, y, je + Ne, je + De, je + Ge, je + Be, "display", "flexShrink"], S = b.concat([Ie, Le, "boxSizing", "max" + He, "max" + We, "position", je, Re, Re + Ge, Re + De, Re + Ne, Re + Be]), k = /([A-Z])/g, $e = function _setState(e) {
    ...
    var _ = (ScrollTrigger.prototype.init = function init(y, x) {
        ...
        Fe) {
            ...
            x && (x.vars.lazy = !1,
            x._initted || !1 !== x.vars.immediateRender && x.render(-.01, !0, !0),
            ...
            }(x) : xe.utils.snap(ce.snapTo),
            f = ce.duration || {
                min: .1,
                max: 2
            },
            f = I(f) ? ke(f.min, f.max) : ke(f, f),
            Z = xe.delayedCall(ce.delay || o / 2 || .1, function() {
                if (!ze || ze === U && !Pe) {
            ...
            oe && (!1 === ie || ie === je || (ie = "flex" !== ba(oe.parentNode).display && Re),
            me.pin = oe,
            !1 !== y.force3D && xe.set(oe, {
                force3D: !0
            }),
            (e = xe.core.getCache(oe)).spacer ? A = e.pinState : (e.spacer = N = Te.createElement("div"),
            ...
            _ = oa("end", i, pe, K, t, r),
            de || (function _makePositionable(e) {
            ...
            me.refresh = function(e) {
                if (!Me && $)
                    if (oe && e && ze)
                        ...
                        w || me.revert();
                        var n, o, i, a, s, l, c, f = (de ? we["inner" + K.d2] : pe["client" + K.d2]) || 0, u = de ? Ke : ea(pe), p = E(pe, K), d = 0, g = 0, h = y.end, v = y.endTrigger || ne, m = y.start || (oe || !ne ? "0 0" : "0 100%"), b = oe && Math.max(0, Ve.indexOf(me)) || 0;
                        if (b)
                            for (l = b; l--; )
                                Ve[l].pin === oe && Ve[l].revert();
                        if (T = Ja(m, ne, f, K, me.scroll(), k, M, me, u, ve, de, p) || (oe ? -.001 : 0),
                        G(h) && (h = h(me)),
                        F(h) && !h.indexOf("+=") && (~h.indexOf(" ") ? h = (F(m) ? m.split(" ")[0] : "") + h : (d = na(h.substr(2), f),
                        h = F(m) ? m : T + d,
                        v = ne)),
                        S = Math.max(T, Ja(h || (v ? "100% 0" : p), v, f, K, me.scroll() + d, _, P, me, u, ve, de, p)) || -.001,
                        O = S - T || (T -= .01) && .001,
                        oe) {
                            for (l = b; l--; )
                            ...
                            de && ((s = {
                                ...
                                position: "fixed"
                            })[Ie] = s.maxWidth = Math.ceil(o.width) + qe,
                        ...
                        me.revert(!1),
                        Me = 0,
                        r !== me.progress && (V && x.totalProgress(r, !0),
                        me.progress = r,
                        me.update()),
            ...
            me.update = function(e, t) {
                var r, n, o, i, a, s = me.scroll(), l = e ? 0 : (s - T) / O, c = l < 0 ? 0 : 1 < l ? 1 : l || 0, f = me.progress;
                if (t && (h = g,
                g = s,
                ce && (Y = X,
                ...
                c !== f && $) {
                    if (i = (a = (r = me.isActive = !!c && c < 1) != (!!f && f < 1)) || !!c != !!f,
                    me.direction = f < c ? 1 : -1,
                    me.progress = c,
                    ue || (!V || Me || Ee ? x && x.totalProgress(c, !!Me) : (V.vars.totalProgress = c,
                    V.invalidate().restart())),
                    oe)
                        if (e && ie && (N.style[ie + K.os2] = m),
                        de) {
                            if (i) {
                                if (o = !e && s + 1 >= E(pe, K),
                                fe) {
                                    ...
                                    !function _reparent(e, t) {
                                        if (e.parentNode !== t) {
                                            ...
                                            if (t === Se)
                                                ...
                                                n = ba(e))
                                                    +r || Qe.test(r) || !n[r] || "string" != typeof o[r] || "0" === r || (o[r] = n[r]);
                                            else
                                                o.cssText = e._stOrig;
                                            t.appendChild(e)
                                        }
                            ...
                            v(j + W * c);
                    !ce || d.tween || Me || Ee || (U = ze,
                    Z.restart(!0)),
                    ee && a && (!le || r) && Ce(ee.targets).forEach(function(e) {
                        return e.classList[r ? "add" : "remove"](ee.className)
                    }),
                    !Q || ue || e || Q(me),
                    i && !Me ? (n = c && !f ? 0 : 1 === c ? 1 : 1 === f ? 2 : 3,
                    1 === c && le ? me.kill() : ue && (o = !a && "none" !== he[n + 1] && he[n + 1] || he[n],
                    x && ("complete" === o || "reset" === o || o in x) && ("complete" === o ? x.pause().totalProgress(1) : "reset" === o ? x.restart(!0).pause() : x[o]()),
                    Q && Q(me)),
                    !a && Ee || (te && a && te(me),
                    ge[n] && ge[n](me),
                    le && (ge[n] = 0),
                    a || ge[n = 1 === c ? 1 : 3] && ge[n](me))) : ue && Q && !Me && Q(me)
                }
                J && (b(s + (M._isFlipped ? 1 : 0)),
                J(s))
            }
            ,
            me.enable = function() {
                ...
                x && (x.add ? xe.delayedCall(.01, me.refresh) && (O = .01) && (T = S = 0) : me.refresh()))
            }
            ,
    ...
    ScrollTrigger.register = function register(e) {
        if (xe = e || B(),
        A() && window.document && (we = window,
        Te = document,
        x = Te.documentElement,
        Se = Te.body),
        xe && (Ce = xe.utils.toArray,
        ke = xe.utils.clamp,
        ...
        Se)) {
            ...
            i = [we, Te, x, Se],
            ia(Te, "scroll", ta);
            var t, r = Se.style, n = r.borderTop;
    ...
    function ScrollTrigger(e, t) {
        o || ScrollTrigger.register(xe) || console.warn("Please gsap.registerPlugin(ScrollTrigger)"),
        this.init(e, t)
    }
    _.version = "3.3.3",
    ...
    _.batch = function(e, t) {
        ...
        for (r in t)
            o[r] = "on" === r.substr(0, 2) && G(t[r]) && "onRefreshInit" !== r ? wg(0, t[r]) : t[r];
        return G(a) && (a = a(),
